...
@WebServlet(urlPatterns = "/tableBundleListServlets")
public class TableBundleListServlets extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest requerst, HttpServletResponse response)
        ...
        ArrayList<String> tablesListWithString = (ArrayList<String>) bundlesData.get("tableListWithString");
